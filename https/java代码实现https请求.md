...
public class OKHTTPShuangXiang {
    ...
    private final static String caPath = "D:\\https\\ssl\\server.cer";


    public static void main(String[] args) throws Exception {
        InputStream insCer = new FileInputStream(new File(caPath));
        InputStream[] insCerArry = new InputStream[]{insCer};
        InputStream insJksDir = new FileInputStream(PFX_PATH);
        //双向
        SSLParams sslParams = getSslSocketFactory(insCerArry,insJksDir,PFX_PWD);
        //单向
//        SSLParams sslParams = getSslSocketFactory(insCerArry,null,null);
        ...
        Request request=new Request.Builder()
                .url("https://10.32.33.48:7002/api/fep/kms-service/GetDictionary")
                .build();
